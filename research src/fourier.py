...
sys.path.append("./../sdo_augmentation/")
...
def main():
    ...
    euv_image = Image.open('./../sdo_augmentation/data/euv/fd/20120403_000036_aia.lev1_euv_12s_4k.jpg')
    euv_image = np.array(euv_image.convert('L')) / 255

    # Select random pickle image from dataset and normalize it
    pickle_paths = glob.glob('./../sdo_augmentation/data/euv/tiles/*.p')
